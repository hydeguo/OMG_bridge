...
Pod::Spec.new do |s|
  s.name             = 'OMG_bridge'
  s.version          = '0.1.0'
  s.summary          = 'A short description of OMG_bridge.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Hyde Guo/OMG_bridge'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Hyde Guo' => 'hydeguo@onwardsmg.com' }
  s.source           = { :git => 'https://github.com/Hyde Guo/OMG_bridge.git', :tag => s.version.to_s }
